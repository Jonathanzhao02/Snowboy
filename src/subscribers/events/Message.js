...
module.exports = function (client) {
  ...
  async function onMessage (msg) {
    ...
    if (!guildClient.textChannel || !guildClient.connected) guildClient.textChannel = msg.channel
    ...
    if (guildClient.connected && msg.channel.id !== guildClient.textChannel.id && Commands.restricted.get(commandName)) {
    ...
    } else if (guildClient.connected && msg.member.voice.channelID !== guildClient.voiceChannel.id && Commands.restricted.get(commandName)) {
      guildClient.sendMsg(
